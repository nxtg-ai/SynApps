...
def _reset_all_stores() -> None:
    ...
    flow_collaborator_role_store.reset()
    flow_collaborator_store.reset()
    flow_custom_domain_store.reset()
    ...
    flow_allowed_origins_store.reset()
    ...
    flow_execution_hook_store.reset()
